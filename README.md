...
My solutions to the [Reintroduction to proofs](https://adam.math.hhu.de/#/g/emilyriehl/reintroductiontoproofs) lean game. Most of the code uses term-mode proofs, except proofs for initial worlds ([type_world](./type_world), [function_world](./function_world) and [implication_world](./implication_world)) which use simple tactics like `assumption`,  `apply`.  
